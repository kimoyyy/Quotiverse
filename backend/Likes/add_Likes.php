...
$sql_query="INSERT INTO Likes (`like_id`,`id`,`quote_id`) VALUES('".$like_id."','".$id."','".$quote_id."')";
 // sql query for inserting data into database
 ...
 if(mysqli_query($con,$sql_query))
 {
  ...
  alert('Likes added Successfully ');
...
<div id="container"> &<div   id="table-responsive">
    ...
    <tr>
    <td align="center"><a href="indexLikes.php">back to main page</a></td>
    </tr>
   ...
   <label for="like_id" class="form-label">Like_id:</label>
    ...
    <td>
    <input type="number" class="form-control" id="like_id" name="like_id" required placeholder="Like_id">
    </td>
    </tr>
    <tr>
   <td>
